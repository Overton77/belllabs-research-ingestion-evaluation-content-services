...
| REQ-CP-DA-004 | Foundation placement decision | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-DEEP-AGENT-PLACEMENT-V1 | WP-CP-040 | local Markdown | placement/fallback tests | evidence_v2/WP-CP-040 | planned |
| REQ-CP-DA-005 | Foundation capability decision | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-DEEP-AGENT-BINDING-V1 | WP-CP-040, WP-CP-050 | local Markdown | exact attachment vertical | evidence_v2/WP-CP-050 | planned |
| REQ-CP-DA-006 | Catalog/runtime boundary | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-DEEP-AGENT-BINDING-V1 | WP-CP-040 | local Markdown | runtime access guards | evidence_v2/WP-CP-040 | planned |
| REQ-CP-DA-007 | Foundation sync-subagent decision | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-DEEP-AGENT-PROFILE-V1 | WP-CP-040 | local Markdown | delegation ceiling tests | evidence_v2/WP-CP-040 | planned |
...
| REQ-CP-DA-013 | Pre-research F4 workspace | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-WORKSPACE-MANIFEST-V1 | WP-CP-040 | local Markdown | workspace ownership tests | evidence_v2/WP-CP-040 | planned |
| REQ-CP-DA-014 | Pre-research F4 artifact | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-ARTIFACT-PROMOTION-V1 | WP-CP-040 | local Markdown | promotion/idempotency tests | evidence_v2/WP-CP-040 | planned |
| REQ-CP-DA-015 | Pre-research F4 snapshot | ADR-0003 | SPEC-CP-DEEP-AGENT-RUNTIME | CON-CP-SNAPSHOT-V1 | WP-CP-040 | local Markdown | clone/reauthorization tests | evidence_v2/WP-CP-040 | planned |
...
| REQ-BP-SG-008 | Pre-research F3 invalidation | ADR-0003 | SPEC-BP-STAGEGRAPH | CON-BP-STAGE-DECISION-V1 | WP-BP-010 | local Markdown | minimal reuse tests | evidence_v2/WP-BP-010 | planned |
| REQ-BP-SG-009 | Pre-research F3 waits/cancellation | ADR-0003 | SPEC-BP-STAGEGRAPH | CON-BP-STAGE-DECISION-V1 | WP-BP-010 | local Markdown | wait/cancel/late-result tests | evidence_v2/WP-BP-010 | planned |
| REQ-BP-SG-010 | Pre-research F3 obligations | ADR-0003 | SPEC-BP-STAGEGRAPH | CON-BP-STAGE-DECISION-V1 | WP-BP-010, WP-CP-050 | local Markdown | obligation completion | evidence_v2/WP-BP-010 | planned |
